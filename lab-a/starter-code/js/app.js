...
function displayPics(){
  ...
  // PUT YOUR RESPONSE IN THIS COMMENT "I think is because let declares a block scope local variable and the console.log is outside the block of code from the function."
  console.log(viewed);
